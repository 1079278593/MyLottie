    ...
    if (cornerPoint.y == currentPoint.y) {
        ...
        if (cornerPoint.x < currentPoint.x) {
            ...
            if (radius) {
                ...
                CGPoint cp2 = (clockwise ? CGPointMake(curvePoint.x, curvePoint.y + (radius * ellipseControlPointPercentage)) : CGPointMake(curvePoint.x, curvePoint.y - (radius * ellipseControlPointPercentage)));
        ...
        if (cornerPoint.y < currentPoint.y) {
            ...
            if (radius) {
                ...
                CGPoint cp2 = (clockwise ? CGPointMake(curvePoint.x - (radius * ellipseControlPointPercentage), curvePoint.y) : CGPointMake(curvePoint.x + (radius * ellipseControlPointPercentage), curvePoint.y));
                [path LOT_addCurveToPoint:curvePoint controlPoint1:cp1 controlPoint2:cp2];
            }
...
- (void)performLocalUpdate {
    ...
    CGPoint startPoint = (clockWise ? CGPointMake(topRight.x, topRight.y + radius) : CGPointMake(topRight.x - radius, topRight.y));
